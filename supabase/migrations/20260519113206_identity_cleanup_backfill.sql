-- Migration 20260519113206: backward-compatible identity cleanup.
--
-- Goals:
...
-- - no quota logic touched (quota never reads is_internal)
...
-- - After deploy, run the companion verification queries in
--   20260519113206_identity_cleanup_backfill.verify.sql.
